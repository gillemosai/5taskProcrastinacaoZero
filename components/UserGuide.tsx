            ...
            <div className={`relative w-full max-w-lg max-h-[85vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col ${isDarkMode ? 'bg-background-dark border border-slate-800' : 'bg-slate-50 border border-slate-200'}`}>
                ...
                <div className={`flex items-center justify-between px-5 py-4 border-b ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
                    <div>
                        ...
                        <p className={`text-[11px] mt-0.5 ${muted}`}>Guia rápido v5.3.3</p>
                    </div>
                ...
                <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
                    ...
                    <div className={`rounded-2xl p-4 border-l-4 border-purple-500 ${card}`}>
                        <h3 className={`font-bold text-sm mb-3 ${accent}`}>📋 Abas Inteligentes <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ml-1 ${isDarkMode ? 'bg-purple-500/20 text-purple-400' : 'bg-purple-100 text-purple-600'}`}>v5.3.3</span></h3>
                        <div className="space-y-2.5">
                            <div className="flex items-start gap-2.5">
                                <LayoutGrid size={15} className="text-purple-400 shrink-0 mt-0.5" />
                                <p className={`text-[12px] leading-relaxed ${muted}`}>
                    ...
                    <div className={`rounded-2xl p-4 border-l-4 border-emerald-500 ${card}`}>
                        <h3 className={`font-bold text-sm mb-3 ${accent}`}>🎉 Dia Produtivo <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ml-1 ${isDarkMode ? 'bg-emerald-500/20 text-emerald-400' : 'bg-emerald-100 text-emerald-600'}`}>v5.3.3</span></h3>
                        <div className="space-y-2.5">
                            <div className="flex items-start gap-2.5">
                    ...
                    <div className={`rounded-2xl p-4 border-l-4 border-accent-cyan ${card}`}>
                        <h3 className={`font-bold text-sm mb-3 ${accent}`}>✨ Experiência Tátil <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ml-1 ${isDarkMode ? 'bg-cyan-500/20 text-cyan-400' : 'bg-cyan-100 text-cyan-600'}`}>v5.3.3</span></h3>
                        <div className="space-y-2.5">
                            <div className="flex items-start gap-2.5">
