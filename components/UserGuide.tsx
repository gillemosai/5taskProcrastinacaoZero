            ...
            <div className={`relative w-full max-w-lg max-h-[85vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col ${isDarkMode ? 'bg-background-dark border border-slate-800' : 'bg-slate-50 border border-slate-200'}`}>
                ...
                <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
                    ...
                    <div className={`rounded-2xl p-4 border-l-4 border-neon-blue ${card}`}>
                        <h3 className={`font-bold text-sm mb-3 ${accent}`}>🎓 Novidades <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ml-1 ${isDarkMode ? 'bg-neon-blue/20 text-neon-blue' : 'bg-blue-100 text-blue-600'}`}>v6.0.0.1</span></h3>
                        <div className="space-y-2.5">
                            <div className="flex items-start gap-2.5">
