...
export default function CalendarSidebar({
  ...
  // Helper: Get tasks categories for a specific date
  ...
  return (
    <div className="flex flex-col gap-6 w-full text-slate-700 dark:text-slate-300">
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-xs dark:border-slate-800/80 dark:bg-slate-900/90">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-1.5">
            <CalendarIcon className="h-4.5 w-4.5 text-indigo-600 dark:text-indigo-400" />
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="rounded-lg p-1 hover:bg-slate-50 text-slate-500 hover:text-slate-800 dark:hover:bg-slate-800 dark:text-slate-400 dark:hover:text-slate-200 transition-colors"
              title="Mês Anterior"
            >
            ...
            <button
              ...
              className="px-2 py-1 text-xs font-semibold rounded-md border border-slate-200 bg-slate-50/50 hover:bg-slate-50 text-slate-600 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-400 dark:hover:bg-slate-900 transition-colors"
            >
              Hoje
            </button>
            <button
          ...
          {monthCells.map((cell, idx) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center aspect-square rounded-xl p-1 transition-all select-none group ${
                  isSelected
              ...
              >
                <div className="flex items-center gap-2.5">
                  <input
                    ...
                    className="accent-indigo-600 rounded-sm h-4 w-4 transition-transform group-hover:scale-105"
                  />
                ...
                {dayCount > 0 && (
                  <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-slate-100 dark:bg-slate-950 text-slate-500 dark:text-slate-400">
                    {dayCount}
                  </span>
                )}
              </label>
